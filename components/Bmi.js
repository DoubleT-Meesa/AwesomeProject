...
export default function Bmi() {    
    ...
    const compute = () => {
        ...
        else if (output>=18.5 && output<=24.9)Description ="Normal";
        else if (output>=25 && output<=29.9)Description ="Overweight";
        else if (output>=30 && output<=34.9)Description ="Obese";
        else if (output>=35)Description ="Extremely Obese ";
    ...
    <View style={{ 
        ...
        <Text style={{ fontSize : 50 }}>{cal}</Text>
